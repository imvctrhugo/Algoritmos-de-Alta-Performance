...
int main()
{
    //Criação de vetores para armazenamento de dados.
    ...
    //Percorre a lista dos RM's calculando suas respectivas médias.
    for(int i = 0; i < 40; i++)
    {
        if(rm[i] != "")
        {
    ...
    //Percore o vetor das médias e define os aprovados de acordo com o critério de média ( >= 6)
    for(int n = 0; n < 40; n++)
    {
